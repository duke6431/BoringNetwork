...
extension AsyncClient {
    ...
    @inlinable
    public func object<Response: Decodable>(from endpoint: Endpoint, errorHandler: NetworkError.NetHandler? = nil) async throws -> Response {
    ...
    @inlinable
    public func array<Response: Decodable>(from endpoint: Endpoint, errorHandler: NetworkError.NetHandler? = nil) async throws -> [Response] {
    ...
    @inlinable
    public func wrapped<Response: Decodable, Wrapper: Wrappable<Response>>(from endpoint: Endpoint, errorHandler: NetworkError.NetHandler? = nil, using: Wrapper.Type) async throws -> Response {
    ...
    @inlinable
    public func wrappedArray<Response: Decodable, Wrapper: Wrappable<Response>>(from endpoint: Endpoint, errorHandler: NetworkError.NetHandler? = nil, using: Wrapper.Type) async throws -> [Response] {
