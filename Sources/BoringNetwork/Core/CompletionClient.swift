...
extension CompletionClient {
    ...
    @discardableResult
    public func object<Request: Encodable, Response: Decodable>(from endpoint: any Endpoint<Request>, errorHandler: NetworkError.NetHandler? = nil, completion: @escaping (Result<Response, Error>) -> Void) -> Cancellable? {
    ...
    @discardableResult
    public func array<Request: Encodable, Response: Decodable>(from endpoint: any Endpoint<Request>, errorHandler: NetworkError.NetHandler? = nil, completion: @escaping (Result<[Response], Error>) -> Void) -> Cancellable? {
    ...
    @discardableResult
    public func wrappedResponse<Request: Encodable, Response: Decodable, Wrapper: Wrappable<Response>>(from endpoint: any Endpoint<Request>, errorHandler: NetworkError.NetHandler? = nil, using: Wrapper.Type, completion: @escaping (Result<Response, Error>) -> Void) -> Cancellable? {
    ...
    @discardableResult
    public func wrappedArrayResponse<Request: Encodable, Response: Decodable, Wrapper: Wrappable<Response>>(from endpoint: any Endpoint<Request>, errorHandler: NetworkError.NetHandler? = nil, using: Wrapper.Type, completion: @escaping (Result<[Response], Error>) -> Void) -> Cancellable? {
